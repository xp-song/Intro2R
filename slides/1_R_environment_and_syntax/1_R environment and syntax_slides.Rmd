...
#Address working directory issues with Knitr:
library(ezknitr)
ezknit(file = "slides/source_files/1_R environment and syntax_slides.Rmd", out_dir = "slides")
```
...
- They are documents that allow us to intersperse regular text with chunks of code
...
.footnote[
[1] All materials in this course were created from _.Rmd_ files. We will work within these source files in the the _/notes_ folder during the workshop (rendered notes are viewable in HTML). The course slides and their source files are located at _/slides_.
]
...
[Download the materials for this workshop](https://github.com/xp-song/Intro2R/archive/master.zip) from the Github repository __Intro2R__  
https://github.com/xp-song/Intro2R  

Open up the RStudio Project file **_Intro2R.Rproj_**  

In the file browser (bottom-right panel), navigate to _/notes_ and open the R Notebook   
**_1_R environment and syntax.Rmd_**
...
```{r eval = TRUE, echo = FALSE, eval = FALSE, out.height=1000}
knitr::include_graphics("RStudio.png")
```


- Try creating a new RStudio Project ()

- Try creating a new R Notebook (_File > New File > R Notebook_)


The folder it is placed in is the 'working directory', and where all sorts of (hidden) files will be stored (e.g. .Rhistory containing past code you ran in the last session, .Rprofile containing your preferences/settings, etc.). The .Rproj file also interfaces with version control systems (i.e. Git).

??

RProj file: 'homing beacon'
