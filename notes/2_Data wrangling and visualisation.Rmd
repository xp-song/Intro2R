...
Install necessary packages on your computer (you only need to do this once):
...
- Other packages that provide functions for specific analyses and visualisations (e.g. interactive visualisations, geospatial analyses)  

```{r install_packages, eval = FALSE, message = FALSE}
install.packages("tidyverse") #data manipulation/visualisation

#specific data manipulation
install.packages("data.table") # quick data manipulation
install.packages("stringr") # string manipulation
install.packages("forcats") # factor manipulation

#specific visualisations
install.packages("highcharter") # interactive visualisation
install.packages("countrycode") # map country names to country code
...
Load dataset `diamonds` from the package `ggplot2`:
```{r}
data(diamonds, package = "ggplot2")
```

__Code the following figures:__  

![](../output/diamond_price.jpeg)

<br>

![](../output/diamond_scatter.jpeg)

<br>

__Interactive Graphs using Plotly__  

- Try executing the following code chunk in the _.Rmd_ file:
